...
class TextComponse extends StatefulWidget {
  @override
  _TextComponseState createState() => _TextComponseState();
}

class _TextComponseState extends State<TextComponse> {
  bool _isComponsing = false;
  final _textContraller = TextEditingController();

  void _reset() {
    _textContraller.clear();
    setState(() {
      _isComponsing = false;
    });
  }
                ...
                child: Theme.of(context).platform == TargetPlatform.iOS
                    ? CupertinoButton(
                        ...
                        onPressed: _isComponsing ? () {
                          _handleSubmitted(_textContraller.text);
                          _reset();
                        } : null)
                    : IconButton(
